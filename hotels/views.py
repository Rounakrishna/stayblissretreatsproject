...
def LITTLE_HEART_RESORT(requests):
    return render(requests,'littleheartresort.html')

def DAFFODIL_COTTAGE(requests):
...
def AYODHAYA_STAY_HOTEL(requests):
    return render(requests,'ayodhayastayhotel.html')
